      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Add New Stock Transfer</h3>
            <a href="{{route('admin.stock-transfers.index')}}" class="btn btn-info float-right"> <i
                class="fas fa-arrow-left"></i> Back</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            {!! Form::model($stock_transfer, ['route' => ['admin.stock-transfers.store'], 'method' => 'post', 'files'=> false,
            'id'=>'stockTransferForm']) !!}
            @include('admin.stocktransfers.form')
            {!! Form::submit('Add', ['class' => 'btn btn-primary submitBtn', 'id'=>'submitStockTransferBtn']) !!}
            {!! Form::close() !!}
          </div>
          <!-- /.card-body -->
        </div>

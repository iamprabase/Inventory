...
@include('admin.locations.partials.customcss')
@endsection
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-sm-12">
              <a href="{{route('admin.locations.create')}}" class="btn btn-info float-right"> <i class="fas fa-plus"></i>
                Create New</a>
            </div>
          </div>
          <!-- /.card-header -->
...
@include('admin.locations.partials.customjs')
@endsection
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            {!! Form::model($purchase_order, ['route' => ['admin.purchase-orders.store'], 'method' => 'post', 'files'=> false,
            'id'=>'purchaseOrderForm']) !!}
            @include('admin.purchaseorders.form')
            {!! Form::submit('Add', ['class' => 'btn btn-primary submitBtn', 'id'=>'submitPurchaseOrderBtn']) !!}
            {!! Form::close() !!}
          </div>
          <!-- /.card-body -->
        </div>
